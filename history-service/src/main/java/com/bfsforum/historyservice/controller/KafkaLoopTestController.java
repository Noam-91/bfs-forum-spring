...
//public class KafkaLoopTestController {
//
//    private static final Logger log = LoggerFactory.getLogger(KafkaLoopTestController.class);
//
//    private final RequestReplyManager<List<String>> requestReplyManager;
//    private final StreamBridge streamBridge;
//    private final String requestBinding;
//    private final String responseBinding;
//
//    public KafkaLoopTestController(
//            RequestReplyManager<List<String>> requestReplyManager,
//            StreamBridge streamBridge,
//            @Value("${bfs-forum.kafka.request-binding-name}") String requestBinding,
//            @Value("${bfs-forum.kafka.response-binding-name}") String responseBinding
//    ) {
...
//     */
//    @PostMapping("/loop")
//    public ResponseEntity<List<String>> sendLoop(@RequestBody List<String> ids) {
//        // a) create future and register it with correlationId
//        String correlationId = UUID.randomUUID().toString();
//        CompletableFuture<List<String>> future = requestReplyManager.createAndStoreFuture(correlationId);
//
//        // b) send enrichment request
//        Message<List<String>> requestMsg = MessageBuilder.withPayload(ids)
//                .setHeader(KafkaHeaders.CORRELATION_ID, correlationId)
//                .build();
//        boolean reqSent = streamBridge.send(requestBinding, requestMsg);
//        log.info("Request sent to '{}': {}", requestBinding, reqSent);
//
//        // c) simulate response by sending the same payload to response binding
//        Message<List<String>> responseMsg = MessageBuilder.withPayload(ids)
//                .setHeader(KafkaHeaders.CORRELATION_ID, correlationId)
//                .build();
//        boolean respSent = streamBridge.send(responseBinding, responseMsg);
//        log.info("Response sent to '{}': {}", responseBinding, respSent);
//
//        // d) wait for the future to complete and return the payload
//        List<String> result = requestReplyManager.awaitFuture(correlationId, future);
